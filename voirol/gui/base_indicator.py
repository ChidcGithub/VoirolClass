...
class BaseGlIndicatorWidget(QWidget):
    ...
    def __init__(self):
        ...
        self._levels: list[float] = [0.0, 0.0, 0.0]
        self._smooth_levels: list[float] = [0.0, 0.0, 0.0]
    ...
    def _screen_cx(self) -> int:
        return QApplication.primaryScreen().geometry().width() // 2
